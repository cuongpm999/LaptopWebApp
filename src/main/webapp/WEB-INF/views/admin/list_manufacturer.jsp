								...
								<tbody id="myTable">
									<c:forEach var="manufacturer" items="${manufacturers}">
										<tr>
											...
											<td><a href="/admin/edit-manufacturer/${manufacturer.id }"
												class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
												<a href="javascript:void(0);"
												onclick="Shop.deleteForm('modalDeleteForm', ${manufacturer.id }, '/rest/api/manufacturer/delete')"
