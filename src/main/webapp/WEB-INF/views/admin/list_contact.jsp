					...
					<div class="col-md-12">
						<div class="form-add">
							...
							<table class="table">
								...
								<tbody id="myTable">
									<c:forEach var="list_contacts" items="${contacts }">
										<tr>
											<td>${list_contacts.fullName }</td>
											<td>${list_contacts.email }</td>
											<td>${list_contacts.mobile }</td>
											<td><a href="/admin/edit-contact/${list_contacts.id }"
												class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
												<a href="javascript:void(0);"
												onclick="Shop.deleteForm('modalDeleteForm', ${list_contacts.id }, '/rest/api/contact/delete')"
