...
<head>
    ...
    <!--/google-fonts-->
    <link href="//fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,700;1,300&display=swap" rel="stylesheet">
    <!--//google-fonts-->
</head>
<!-- //Head -->
<!-- Body -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="user-action">
                            <div class="btn btn-signup">
                                <a href="/"><img src="/img/arrow.png" alt="" class=""> Back to home </a>
                            </div>
                        </div>
                    </div>
                </div>
...
*/
    ...
    .w3l-error-spin-content {
        background: url('https://res.cloudinary.com/cuongpham/image/upload/bg_xyb0zh.jpg') no-repeat center;
