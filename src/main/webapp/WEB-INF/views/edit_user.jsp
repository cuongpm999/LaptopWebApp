				...
				<c:choose>
					<c:when test="${status=='success'}">
						<div class="alert alert-success">
							<strong>Success!</strong> Bạn đã sửa thông tin thành công!
						</div>
					</c:when>
					<c:when test="${status=='faile'}">
						<div class="alert alert-danger">
							<strong>Faile!</strong> Bạn sửa thông tin thất bại!
						</div>
					</c:when>
				</c:choose>
				<div class="card-body">
					<div class="panel-body">
						<form:form modelAttribute="userDis" action="/edit-user"
							...
							<div class="form-group">
								<label>Chọn ảnh:&ensp;</label> <input type="file"
									name="userImage" />
							</div>

							<div class="card-body">
								<button type="submit" class="btn btn-success">
									<i class="fas fa-download"></i> Sửa
								</button>
							</div>
						</form:form>
					</div>
